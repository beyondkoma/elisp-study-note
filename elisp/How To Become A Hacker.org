...
Numerous translations of this document are available: Arabic Belorussian Chinese (Simplified), Czech, Danish, Dutch, Estonian, German, Greek Italian Hebrew, Japanese, Lithuanian, Norwegian, Persian Portuguese (Brazilian), Romanian Spanish, Turkish, and Swedish. Note that since this document changes occasionally, they may be out of date to varying degrees.
